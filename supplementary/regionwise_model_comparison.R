...
#---------------------------------MODEL5----------------------------------------
# total similarity strength ~ age + sex + (1|hemisphere) + (1|subject)
...
df_model5 <- as.data.frame(result_list)
write.csv(df_model5,
          file = file.path(project_root, "lmer_MIND_fixed_age_sex_random_hemi_subject.csv"),
          row.names = FALSE)
print(df_model5)

#---------------------------------MODEL6----------------------------------------
# total similarity strength ~ age + sex + age*sex + (1|hemisphere) + (1|subject)
...
for (region_id in unique(data$region)) {
  ...
  region_data <- filter(data, region == region_id)
  model <- lmer(value ~ age + sex + age:sex + (1|hemi) + (1|subject), data = region_data, REML = TRUE)
...
df_model6 <- as.data.frame(result_list)
write.csv(df_model6,
          file = file.path(project_root, "lmer_MIND_fixed_age_sex_ageBYsex_random_hemi_subject.csv"),
          row.names = FALSE)
print(df_model6)
